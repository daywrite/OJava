...
using OBear.EntityFramework.Properties;
...
using OBear.EntityFramework.Migrations;
...
namespace OBear.EntityFramework
{
    ...
    /// 数据上下文初始化基类
    /// </summary>
    public abstract class DbContextInitializerBase<TDbContext,A>
